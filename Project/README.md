...
| ------------- | --------------------------- | ------------------------------------------ |
| `INT_TYPE`    | `int`                       | Integer type keyword.                      |
| `FLOAT_TYPE`  | `float`                     | Floating-point type keyword.               |
| `VOID_TYPE`   | `void`                      | Void return type keyword.                  |
| `STRUCT`      | `struct`                    | Structure definition keyword.              |
| `IF`          | `if`                        | Conditional statement keyword.             |
| `ELSE`        | `else`                      | Alternative branch keyword.                |
| `WHILE`       | `while`                     | While loop keyword.                        |
| `FOR`         | `for`                       | For loop keyword.                          |
| `SWITCH`      | `switch`                    | Switch statement keyword.                  |
| `CASE`        | `case`                      | Switch case label keyword.                 |
| `DEFAULT`     | `default`                   | Default switch label keyword.              |
| `RETURN`      | `return`                    | Function return keyword.                   |
| `BREAK`       | `break`                     | Loop/switch break keyword.                 |
...
| `MINUS`       | `-`                         | Subtraction operator or unary minus.       |
...
| `COLON`       | `:`                         | Ternary/switch separator.                  |
| `DOT`         | `.`                         | Struct member access operator.             |
...
| `CPP_COMMENT` | `//[^\n]*`                  | Single-line comment.                       |
| `C_COMMENT`   | `/\*[\s\S]*?\*/`            | Multi-line comment.                        |
